...
plt.plot(threads, speedup_no_simd, marker='o', label='Non-SIMD (-O3 Auto)', linewidth=2)
plt.plot(threads, speedup_simd, marker='s', label='Explicit SIMD (#pragma)', linewidth=2)
...
# Ideal speedup for N threads is exactly N
